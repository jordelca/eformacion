        ...
        <section class="col-xs-12 content-header">
            <h1 class="col-xs-12 col-md-6">
                <?= $this->language->getPhrase("key_import_users",$_SESSION['lang']) ?>
...
<!-- FICHA DE REGISTRO -->   
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- <div class="form-group">
                         ...
                         <!-- <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="col-md-2 control-label" for="selectbasic"><?= $this->language->getPhrase("key_delimiter_csv",$_SESSION['lang']) ?></label>
                            <div class="col-md-1">
                              <select id="selectbasic" name="selectbasic" class="form-control">
                                <option value="">,</option>
                          ...
                          <div class="form-group">
                            <label class="col-md-2 control-label" for="selectbasic"><?= $this->language->getPhrase("key_coding",$_SESSION['lang']) ?></label>
                            <div class="col-md-2">
                              <select id="selectbasic" name="selectbasic" class="form-control">
                          ...
                          <div class="form-group">
                            <label class="col-md-2 control-label" for="selectbasic"><?= $this->language->getPhrase("key_preview_rows",$_SESSION['lang']) ?></label>
                            <div class="col-md-2">
                              <select id="selectbasic" name="selectbasic" class="form-control">
                ...
                <div class="col-md-4 control-label pull-right">
                 <button class="btn btn-primary"><?= $this->language->getPhrase("key_register_users",$_SESSION['lang']) ?></button>
                </div>
              </form>
