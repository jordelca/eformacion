...
<section class="col-xs-12 content-header">
    <h1 class="col-xs-12">
    <?= $this->language->getPhrase("key_advanced_search",$_SESSION['lang']) ?>
                        ...
                        <div class="bs-example">
                           <div class="panel-group" id="accordion">
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading">
                                    <h4 class="panel-title">
                                       <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Búsqueda general</a>
                                    </h4>
                                 </div>
                                      ...
                                      <div class="form-group col-lg-8">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                <input readonly="" class="irs-hidden-input" id="range_04" style="display:none;">
                                                
                                                  <div class="button-reset">
                                                      <button class="btn btn-primary js-reset-04">Resetear elección</button>
                                                  </div>
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading">
                                    <h4 class="panel-title">
                                       <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Búsqueda avanzada de usuarios</a>
                                    </h4>
                                 </div>
                                        ...
                                        <div class="form-group col-lg-8">
                                            <form class="form-horizontal" role="form">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                <input readonly="" class="irs-hidden-input" id="range_03" style="display:none;">
                                                <div class="button-reset">
                                                      <button class="btn btn-primary js-reset-03">Resetear elección</button>
                                                </div>
                                                </div>
                                              </div>
