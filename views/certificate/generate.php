        ...
        <section class="col-xs-12 content-header">
            <h1 class="col-xs-12">
                <?= $this->language->getPhrase("key_generate_certificate",$_SESSION['lang']) ?>
                ...
                <div class="box-header table-top">
                 <div class="col-xs-12">
                    <div class="form-group pull-left">
                      <button type="button" class="btn btn-success"><?= $this->language->getPhrase("key_generate_certificate",$_SESSION['lang']) ?></button>
                    </div>
                  </div>
