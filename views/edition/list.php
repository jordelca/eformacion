...
<section class="col-xs-12 content-header">
  <h1 class="col-xs-12">
    <?= $this->language->getPhrase("key_editions",$_SESSION['lang']) ?>
      ...
      <div class="box-header table-top">
        <div class="col-xs-12 nopadding">
          <div class="col-xs-12 col-md-2 form-group pull-left">
            <a href="/<?=$_SESSION['lang'];?>/edition/create" class="col-xs-12 btn btn-success"><?= $this->language->getPhrase("key_create_edition",$_SESSION['lang']) ?></a>
          </div>
            ...
            <table id="example1" class="table table-bordred table-striped">
              ...
              <tbody>
                                         <?php 
                                            ...
                                            $courseList = $this->controller->getEditions();
