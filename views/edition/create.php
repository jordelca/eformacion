        ...
        <section class="col-xs-12 content-header">
            <h1 class="col-xs-12 col-md-6">
                <?= $this->language->getPhrase("key_edition",$_SESSION['lang']) ?>
...
<!-- FICHA DE REGISTRO -->      
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                          ...
                          <div class="panel-body">
                            <div class="form-group required">
                              <label class="col-md-4 control-label"><?= $this->language->getPhrase("key_edition_daterange",$_SESSION['lang']) ?></label>
                              <div class="col-md-4">
                                <input id="textinput" name="daterange" value="01/01/2016 - 31/01/2016"  placeholder="<?= $this->language->getPhrase("key_placeholder_org_name",$_SESSION['lang']) ?>" class="form-control input-md" required="required" type="text">
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="col-md-4 control-label pull-right">
                 <button class="btn btn-primary"><?= $this->language->getPhrase("key_create_edition",$_SESSION['lang']) ?></button>
                </div>
              </form>
